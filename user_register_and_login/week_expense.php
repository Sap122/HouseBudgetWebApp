...
<script type="text/javascript" src="1WeekExpense.js"></script>

</head>

<body>
<div class="content">
<input type="image" src="img/exp2.png" class="heading">
<div class="img" ><br>
...
$sql = "SELECT *  FROM expense WHERE  user_id ='$id' AND (`date` BETWEEN DATE_SUB( CURDATE( ) ,INTERVAL 1 WEEK ) AND CURDATE( )) ";
