...
function fruit_mic(){
            ...
            //    alert("fruit");
                let msg = "१ हफ्ते में  आपने फल पर    " +x1+ "रुपए खर्च किये " ;
...
function vege_mic(){
            ...
            //    alert("vege");
                let msg = "१ हफ्ते में  आपने सब्जी  पर   " +x1+ "रुपए खर्च किये ";
...
function milk_mic(){
          ...
          //      alert("milk");
                let msg = "१ हफ्ते में  आपने दूध पर    " +x1+ "रुपए खर्च किये ";
...
function massala_mic(){
          ...
          //      alert("massala");
                let msg = "१ हफ्ते में  आपने मसाले  पर  " +x1+ "रुपए खर्च किये ";
...
function cereal_mic(){
          ...
          //      alert("cereal");
                let msg = "१ हफ्ते में  आपने  अनाज और दाल  पर  " +x1+ "रुपए खर्च किये "; 
...
function sugar_mic(){
         ...
         //       alert("sugar");
                let msg = "१ हफ्ते में  आपने शक्कर पर  " +x1+ "रुपए खर्च किये "; 
...
function salt_mic(){
         ...
         //       alert("salt");
                let msg = "१ हफ्ते में  आपने नमक  पर  " +x1+ "रुपए खर्च किये ";                
                let speech = new SpeechSynthesisUtterance();
                speech.lang = "hi-IN";
...
function egg_mic(){
         ...
         //       alert("egg");
                let msg = "१ हफ्ते में  आपने  अंडे  पर  " +x1+ "रुपए खर्च किये ";
...
function meat_mic(){
         ...
         //       alert("meat");
                let msg = "१ हफ्ते में  आपने मांस   पर  " +x1+ "रुपए खर्च किये ";
...
function education_mic(){
         ...
         //       alert("education");
                let msg = "१ हफ्ते में  आपने स्कूल या कॉलेज  पर  " +x1+ "रुपए खर्च किये ";
...
function clothes_mic(){
          ...
          //      alert("clothes");
                let msg = "१ हफ्ते में  आपने कपड़ो  पर  " +x1+ "रुपए खर्च किये ";
...
function light_mic(){
             ...
             //   alert("light");
                let msg = "१ हफ्ते में  आपने लाइट बिल  पर  " +x1+ "रुपए खर्च किये ";
...
function gas_mic(){
             ...
             //   alert("gas");
                let msg = "१ हफ्ते में  आपने गैस  बिल  पर  " +x1+ "रुपए खर्च किये ";
...
function phone_mic(){
            ...
            //    alert("phone");
                let msg = "१ हफ्ते में  आपने  फ़ोन  पर  " +x1+ "रुपए खर्च किये ";
...
function cable_mic(){
           ...
           //     alert("cable");
                let msg = "१ हफ्ते में  आपने  केबल बिल या टीवी  पर  " +x1+ "रुपए खर्च किये ";
...
function rent_mic(){
           ...
           //     alert("rent");
                let msg = "१ हफ्ते में  आपने  किराया या रेंट  पर  " +x1+ "रुपए खर्च किये ";
...
function traveling_mic(){
          ...
          //      alert("travel");
                let msg = "१ हफ्ते में  आपने  यात्रा या सफर  पर  " +x1+ "रुपए खर्च किये ";
...
function medical_mic(){
        ...
        //        alert("medical");
                let msg = "१ हफ्ते में  आपने हॉस्पिटल पर  " +x1+ "रुपए खर्च किये " ;
...
function personal_mic(){
          ...
          //      alert("personal");
                let msg = "१ हफ्ते में  आपने खुद  पर  " +x1+ "रुपए खर्च किये " ;
...
function other_mic(){
          ...
          //      alert("other");
                let msg = "१ हफ्ते में  आपने  अन्य  पर  " +x1+ "रुपए खर्च किये " ;
